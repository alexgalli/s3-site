...
var defaultConfig = {
    fromEmail: process.env.from_address,
    subjectPrefix: "",
...
defaultConfig.forwardMapping["@" + process.env.domain] = [
...
// Processes the message data, making updates to recipients and other headers before forwarding message.
